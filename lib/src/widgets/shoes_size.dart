...
import 'package:design_qpp/src/pages/shoes_detail_page.dart';
      ...
      onTap: () {
       ...
       final shoesModel = Provider.of<ShoesModel>(context, listen: false);
        ...
        child: Text('${number.toString().replaceAll('.0', '')}',
            style: TextStyle(
                color: ( this.number == shoesModel.size)? Colors.white :Color(0xffF1A23A) ,
                fontSize: 16,
                fontWeight: FontWeight.bold)),
        width: 45,
        height: 45,
        decoration: BoxDecoration(
            color: ( this.number == shoesModel.size)? Color(0xffF1A23A): Colors.white,
